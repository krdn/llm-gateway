...
cli.command("run <module>", "\uB2E8\uC77C \uBAA8\uB4C8 \uC2E4\uD589").option("--input <path>", "\uC785\uB825 JSON \uD30C\uC77C \uACBD\uB85C").option("--provider <provider>", "\uD504\uB85C\uBC14\uC774\uB354 \uC624\uBC84\uB77C\uC774\uB4DC (anthropic|gemini|openai|...)").option("--model <model>", "\uBAA8\uB378 \uC624\uBC84\uB77C\uC774\uB4DC").option("--output <path>", "\uACB0\uACFC \uCD9C\uB825 \uD30C\uC77C \uACBD\uB85C (\uC0DD\uB7B5 \uC2DC stdout)").action(async (moduleName, opts) => {
...
cli.command("run-all", "\uBAA8\uB4E0 \uBAA8\uB4C8 \uC2E4\uD589 (\uBCD1\uB82C + \uC758\uC874\uC131 \uC21C\uC11C)").option("--input <path>", "\uC785\uB825 JSON \uD30C\uC77C \uACBD\uB85C").option("--output <dir>", "\uACB0\uACFC \uB514\uB809\uD1A0\uB9AC (\uBAA8\uB4C8\uBCC4 JSON)").action(async (opts) => {
...
cli.command("eval", "\uC2A4\uB0C5\uC0F7 \uD68C\uADC0 \uD14C\uC2A4\uD2B8 (TODO: harness \uAD6C\uD604)").option("--update", "\uC2A4\uB0C5\uC0F7 \uAC31\uC2E0").action(() => {
